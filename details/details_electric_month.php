...
$monthSQL = "
    ...
    WHERE $monthCondition $provinceCondition $saleCondition 
    ORDER BY V_Electric_per_month DESC
    LIMIT ?, ?";

$stmt = $objConnect->prepare($monthSQL);
...
<head>
    ...
    <title>รายละเอียดค่าไฟฟ้าต่อเดือน: <?php echo htmlspecialchars($range); ?></title>
...
<body>
    <div class="main-content">
        <h2>รายละเอียดค่าไฟฟ้าต่อเดือน: <?php echo htmlspecialchars($range); ?></h2>
